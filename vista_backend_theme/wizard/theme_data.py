...
class ThemeData(models.TransientModel):
    ...
    def icon_change_theme_default(self):
        ...
        for menu in menu_item:
            ...
            if menu.name == 'Note':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons/notes.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            ...
            if menu.name == 'Timesheets':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons/timesheet.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Events':
                img_path = odoo.tools.misc.file_path(
            ...
            if menu.name == 'Apps':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons/apps.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Discuss':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons/discuss.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Settings':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons/settinga.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
    ...
    def icon_change_theme_green(self):
        ...
        for menu in menu_item:
            if menu.name == 'Contacts':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/contacts.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Link Tracker':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/link-tracker.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Dashboards':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/dashboards.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Sales':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/sales.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Invoicing':
                img_path = odoo.tools.misc.file_path(
            ...
            if menu.name == 'Inventory':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/inventory.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Purchase':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/purchase.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Calendar':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/calendar.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'CRM':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/crm.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Note':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/notes.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Website':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/website.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Point of Sale':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/pos.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Manufacturing':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/manufacturing.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Repairs':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/repairs.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Email Marketing':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/email-marketing.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'SMS Marketing':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/sms-marketing.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Project':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/project.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Surveys':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/surveys.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Employees':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/employee.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Recruitment':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/recruitment.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Attendances':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/attendances.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Time Off':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/timeoff.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Expenses':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/expenses.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Maintenance':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/maintenance.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Live Chat':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/live-chat.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Lunch':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/lunch.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Fleet':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/fleet.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Timesheets':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/timesheet.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Events':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/events.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'eLearning':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/elearning.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Members':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/members.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Apps':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/apps.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Discuss':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/discuss.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Settings':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons_green/settinga.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Accounting':
                img_path = odoo.tools.misc.file_path(
